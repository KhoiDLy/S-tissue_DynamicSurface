...
***************************************************************************************/
  for (i=0; i <= 5; i++){            // read all 4 differential channel pairs AIN0-AIN1, AIN2-AIN3, AIN4-AIN5, AIN6-AIN7
 ...
 */
  ...
  //WAKEUP 0000 0000
  SPI.transfer(0x00);
  delayMicroseconds(180);   // Allow settling time
...
0110 = AIN6 (ADS1256 only)
0111 = AIN7 (ADS1256 only)
1xxx = AINCOM (when NSEL3 = 1, NSEL2, NSEL1, NS EL0 are “don’t care”)
NOTE: When using an ADS1255 make sure to only select the available inputs.
 */
