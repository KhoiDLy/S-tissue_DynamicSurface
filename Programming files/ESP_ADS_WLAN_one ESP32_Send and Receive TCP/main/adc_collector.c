...
/*				adc_val[i] = 8000;*/
				...
				if((i == 0) | (i == 1)){ // Only store the first and the second ADC channels for WIFI sending
					if (!xQueueSend(xQueueToPC, &adc_val[i], portMAX_DELAY)) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if (k == 4){
				if (!xQueueReceive(xQueueGlobal, &GlobalCommand, 10)) {
...
/*			printf("PID local control is doing\n");*/
